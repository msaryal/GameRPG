...
public class Enemy extends GameCharacter{
    ...
    public Enemy(GameScreen gameScreen){
        ...
        this.regions = new TextureRegion(texture).split(119, 106)[0];
        this.textureHP = new Texture("Bar.png");
        this.position = new Vector2(MathUtils.random(0, 1040), MathUtils.random(0, 640));
        while (!gameScreen.getMap().isCellPassable(position)){
            this.position.set(MathUtils.random(0, 1040), MathUtils.random(0, 640));
        }
